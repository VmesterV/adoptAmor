document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para inyectar tarjetas de mascotas después de que se carga la vista 'inicio'
    ...
    function loadContent(pageName) {
        ...
        fetch(url)
            ...
            .then(html => {
                ...
                // Si la página cargada es 'inicio', inyectar las tarjetas de mascotas
                if (pageName === 'inicio') {
                    initializePetGrids();
                }
    ...
    // 3. Cargar contenido inicial ('inicio') al cargar la página
    loadContent('inicio');
